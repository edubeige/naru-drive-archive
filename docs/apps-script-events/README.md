...
### addMajorEvent
```json
{ "action": "addMajorEvent", "title": "학부모 상담주간" }
```

### removeMajorEvent
```json
{ "action": "removeMajorEvent", "id": "major_xxx" }
```

### addScheduleEvent
```json
{ "action": "addScheduleEvent", "date": "2026-03-11", "title": "학급 임원선거" }
```

### removeScheduleEvent
```json
{ "action": "removeScheduleEvent", "id": "schedule_xxx" }
```
